...
// const { asyncHandler } = require('../utils/errors'); // Unused import
...
const loginUserController = async (req, res) => {
  ...
  return sendSuccess(res, ERROR_MESSAGES.LOGIN_SUCCESSFUL, result);
};
...
const refreshTokensController = async (req, res) => {
  ...
  return sendSuccess(res, ERROR_MESSAGES.TOKEN_REFRESHED_SUCCESSFULLY, result);
};
